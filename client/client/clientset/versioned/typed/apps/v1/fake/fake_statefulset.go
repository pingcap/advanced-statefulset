...
import (
	...
	applyconfigurationappsv1 "github.com/pingcap/advanced-statefulset/client/client/applyconfiguration/apps/v1"
...
var statefulsetsResource = schema.GroupVersionResource{Group: "apps.pingcap.com", Version: "v1", Resource: "statefulsets"}

var statefulsetsKind = schema.GroupVersionKind{Group: "apps.pingcap.com", Version: "v1", Kind: "StatefulSet"}
...
func (c *FakeStatefulSets) Apply(ctx context.Context, statefulSet *applyconfigurationappsv1.StatefulSetApplyConfiguration, opts v1.ApplyOptions) (result *appsv1.StatefulSet, err error) {
	if statefulSet == nil {
...
func (c *FakeStatefulSets) ApplyStatus(ctx context.Context, statefulSet *applyconfigurationappsv1.StatefulSetApplyConfiguration, opts v1.ApplyOptions) (result *appsv1.StatefulSet, err error) {
	if statefulSet == nil {
		return nil, fmt.Errorf("statefulSet provided to Apply must not be nil")
	}
	data, err := json.Marshal(statefulSet)
