...
// this file is copied from k8s.io/kubernetes/test/e2e/framework/psp.go @v1.23.17
...
import (
	...
	e2eauth "github.com/pingcap/advanced-statefulset/test/third_party/k8s/auth"
)
