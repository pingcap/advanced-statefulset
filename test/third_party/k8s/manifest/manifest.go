...
// this file is copied from k8s.io/kubernetes/test/e2e/framework/manifest/manifest.go @v1.23.17
...
import (
	...
	e2etestfiles "github.com/pingcap/advanced-statefulset/test/third_party/k8s/testfiles"
)
