...
DOCKER_LIB_VOLUME=${DOCKER_LIB_VOLUME:-advanced-statefulset-docker-lib}
DOCKER_GRAPH_VOLUME=${DOCKER_GRAPH_VOLUME:-advanced-statefulset-docker-graph}
DOCKER_GO_VOLUME=${DOCKER_GO_VOLUME:-advanced-statefulset-go}
NAME=${NAME:-advanced-statefulset-dev}
...
Environments:
    ...
    DOCKER_LIB_VOLUME   the name of docker lib volume, defaults: advanced-statefulset-docker-lib
    DOCKER_GRAPH_VOLUME the name of docker graph volume, defaults: advanced-statefulset-docker-graph
    DOCKER_GO_VOLUME    the name of go cache volume, defaults: advanced-statefulset-go
