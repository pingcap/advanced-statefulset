...
func (c *PingcapV1alpha1Client) AdvancedStatefulSets(namespace string) AdvancedStatefulSetInterface {
	return newAdvancedStatefulSets(c, namespace)
}
